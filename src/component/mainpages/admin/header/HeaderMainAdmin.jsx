           ...
           <ul className="navbar-nav mr-auto">
            ...
            <ul className="navbar-nav mr-auto">
                <li className="nav-item dropdown">
                    <h5 className="nav-link text-white dropdown-toggle"  data-toggle="dropdown" >Category</h5>
            ...
            <ul className="navbar-nav mr-auto">
                <li className="nav-item dropdown">
                    <h5 className="nav-link text-white dropdown-toggle"  data-toggle="dropdown" >User</h5>
                    <ul className="dropdown-menu" role="listbox">
            ...
            <ul className="navbar-nav mr-auto">
                <li className="nav-item dropdown">
                    <h5 className="nav-link text-white dropdown-toggle"  data-toggle="dropdown" >Notification</h5>
                    <ul className="dropdown-menu" role="listbox">
            ...
            <ul className="navbar-nav mr-auto">
                <li className="nav-item dropdown">
                    <h5 className="nav-link text-white dropdown-toggle"  data-toggle="dropdown" >Merchandise</h5>
                    <ul className="dropdown-menu" role="listbox">
            ...
            <ul className="navbar-nav mr-auto">
                <li className="nav-item dropdown">
                    <h5 className="nav-link text-white dropdown-toggle"  data-toggle="dropdown" >Campaign</h5>
                    <ul className="dropdown-menu" role="listbox">
            ...
            <ul className="navbar-nav mr-auto">
                <li className="nav-item dropdown">
                    <h5 className="nav-link text-white dropdown-toggle"  data-toggle="dropdown" >Promotion</h5>
                    <ul className="dropdown-menu" role="listbox">
